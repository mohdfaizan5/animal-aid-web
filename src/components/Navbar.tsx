...
const Navbar = () => {
  return (
    <div className="flex px-10 items-center py-5 justify-between">
      ...
      <nav className="flex gap-7 items-center text-lg ">
        <a className="" href="#">
        ...
        <ModeToggle/>
        <button className="group relative inline-flex h-12 items-center justify-center overflow-hidden rounded-md border border-neutral-200 bg-transparent px-6 font-medium text-white transition-all duration-100 [box-shadow:5px_5px_rgb(9_185_76)] hover:translate-x-[3px] hover:translate-y-[3px] hover:[box-shadow:0px_0px_rgb(82_82_82)]">
          Get started
        </button>{" "}
      </nav>
    </div>
